...
#import dagshub
#dagshub.init(repo_owner='Malaika944', repo_name='Uber_demand_prediction', mlflow=True)

# set the mlflow tracking uri
mlflow.set_tracking_uri("https://dagshub.com/Malaika944/Uber_demand_prediction.mlflow")
